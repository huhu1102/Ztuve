<template>
  <!--  销售计划-->
  <div>
    <el-container  v-if="sendShow==1" style="display: flex;flex-direction: column;justify-content: flex-start;">
                    ...
                    <div class="compay-ifor ">
                      <div>
                        <div>
                          ...
                          <div
                            style="padding: 0 16px;color:white;text-align: right; text-overflow: ellipsis;overflow: hidden; white-space: nowrap;"
                            v-if="plandetail.parentName">
                            ┈┈{{plandetail.parentName}}
                          </div>
                        </div>
                        <div style="text-align: center;padding-top: 10px;color: white;" v-if="plandetail.productName">
                      ...
                      <div style="display:flex;flex-direction: row;justify-content: start;width: 100%;">
                        <div class="pro-plan-head">
                          ...
                          <div class="compay-ifor" style="background-color: #A9DC90;">
                            ...
                            <div class="text-alight company-font" style="text-align: center;padding-top: 10px;"
                                 v-if="plandetail.salesPlan&&plandetail.salesPlan.product&&plandetail.salesPlan.product.producteName">
                              {{plandetail.salesPlan.product.producteName}}
                            </div>
                            <div style="text-align: right;padding-right: 10px;" class="company-font"
                            ...
                            <div class="plan-num-left">
                              <div class="plan-item-right">
                                <div
                                  ...
                                  <div>
                                    ...
                                    <div class="placommafyn-num-detail abandon">
                              ...
                              <div
                                ...
                                <div
                                  ...
                                  <div>
                                    <el-tooltip class="item" effect="dark" content="生产详情" placement="top-start">
...
<script>
  ...
  export default {
    components: {ZtCascader, ZtDialog,sendView,tagTip,manageChart},
    data() {
