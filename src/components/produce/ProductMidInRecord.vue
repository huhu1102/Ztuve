  ...
  export default {
    ...
    methods: {
      ...
      doDelete(ids) {
        ...
        var _this = this;
        this.getRequest("/midProductInRecieving/withdraw?id=" + ids).then(resp => {
      ...
      loadData() {
        var _this = this;
        this.tableLoading = true;
        this.getRequest("/midProductInRecieving/findbypage?page=" + this.currentPage + "&size=10&queryName=" + this
          .keywords).then(resp => {
