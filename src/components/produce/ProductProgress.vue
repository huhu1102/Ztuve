     ...
     <el-header style="padding: 0px;display:flex;justify-content:space-between;align-items: center">
      ...
      <el-main>
        <div style="text-align: left">
          <div style="display:flex;flex-direction: row; justify-content: flex-start;" v-show="dialogFormVisible">
            <el-form :model="process" :rules="rules" style="width: 600px;" ref="addEmpForm" size="small" label-width="90px">
            ...
            <el-button  size="mini" style="height:30px;width: auto ;" type="primary" @click="add('addEmpForm')">确定添加</el-button>
              <el-button  size="mini" style="height:30px;width: auto ;" type="primary"@click="dialogFormVisible=false">取 消</el-button>
            </div>
          </div>
        </div>
